...
//
//    // Tarifs (EXACT as cahier de charge)
...
//            fastestInterval = 500L     // Fastest update 0.5 seconds
...
//
//        // Calculate fare: Base + (Distance × PricePerKm) + (TotalMinutes × PricePerMinute)
//        val totalMinutes = totalSeconds / 60.0  // Convert to decimal minutes
//
//        val distanceFare = accumulatedDistance * PRICE_PER_KM
//        val timeFare = totalMinutes * PRICE_PER_MINUTE
...
//
//        return FareBreakdown(baseFare, distanceFare, timeFare, total)
//    }
//
...
//            .setContentText("%.2f km • %.1f min • %.2f DH".format(
//                accumulatedDistance, timeInMinutes, fare.total))
//            .setStyle(NotificationCompat.BigTextStyle()
//                .bigText("Distance: %.2f km\nTemps: %.1f min\n\nBase: %.2f DH\nDistance: %.2f DH\nTemps: %.2f DH\n\nTOTAL: %.2f DH".format(
//                    accumulatedDistance, timeInMinutes,
